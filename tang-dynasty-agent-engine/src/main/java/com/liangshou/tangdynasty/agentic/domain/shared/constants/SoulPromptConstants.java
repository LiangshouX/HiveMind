package com.liangshou.tangdynasty.agentic.domain.shared.constants;

import com.liangshou.tangdynasty.agentic.common.util.SoulPromptLoader;
...
public class SoulPromptConstants {
     ...
     * 宰相 Agent Soul 提示词内容
     */
    private static final String ZDXL_BUILTIN_SOUL = SoulPromptLoader.loadSoul("ZDXL");
