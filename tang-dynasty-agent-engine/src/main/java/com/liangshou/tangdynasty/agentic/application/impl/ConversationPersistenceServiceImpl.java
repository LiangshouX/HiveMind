...
import com.liangshou.tangdynasty.agentic.domain.memory.model.ConversationMemoryDocument;
import com.liangshou.tangdynasty.agentic.domain.memory.model.ConversationViewDocument;
import com.liangshou.tangdynasty.agentic.domain.memory.model.StoredMessage;
import com.liangshou.tangdynasty.agentic.domain.memory.model.StoredMessageContent;
...
/**
 * 对话持久化服务实现 - 管理会话历史在 MongoDB 中的存储和检索。
 *
 * <p>该实现提供以下核心功能：</p>
 * <ul>
...
public class ConversationPersistenceServiceImpl implements IConversationPersistenceService {
    ...
    private static final Logger log = LoggerFactory.getLogger(ConversationPersistenceServiceImpl.class);
