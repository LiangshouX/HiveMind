package com.liangshou.tangdynasty.agentic.agents.provider.old.impl;

import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONArray;
import com.alibaba.fastjson2.JSONObject;
import com.liangshou.tangdynasty.agentic.agents.provider.old.AbstractProvider;
import com.liangshou.tangdynasty.agentic.agents.provider.old.model.CheckResult;
...
//            builder.defaultOptions(toGenerateOptions(kwargs));
    ...
    private GenerateOptions toGenerateOptions(Map<String, Object> kwargs) {
        ...
        for (Map.Entry<String, Object> entry : kwargs.entrySet()) {
            ...
            if (Objects.equals(k, ARG_STREAM) || Objects.equals(k, "stream_enabled") || Objects.equals(k, "streamEnabled")) {
                continue;
            }
