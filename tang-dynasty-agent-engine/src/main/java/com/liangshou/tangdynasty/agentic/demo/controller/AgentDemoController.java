package com.liangshou.tangdynasty.agentic.demo.controller;
...
/**
 * AgentDemoController：仅作为快速演示、测试 Agent 研发流程，不可作为正式生产环境使用！
 * <p>
 * 由于是快速演示，不考虑架构分层、系统设计等，所有功能均在这一个类中实现。
 */
@RestController
@RequestMapping("/demo/agent")
public class AgentDemoController {

    private static final Logger logger = LoggerFactory.getLogger(AgentDemoController.class);
    ...
    public AgentDemoController(AgentscopeBrowserUseAgent agent) {
        this.agent = agent;
    }
