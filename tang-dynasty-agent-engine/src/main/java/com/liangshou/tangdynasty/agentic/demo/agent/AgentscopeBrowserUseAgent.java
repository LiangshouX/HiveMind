...
package com.liangshou.tangdynasty.agentic.demo.agent;
...
import static com.liangshou.tangdynasty.agentic.common.constants.SoulPromptConstants.BROWSER_SYSTEM_PROMPT;


/**
* AgentScope 浏览器使用代理实现 Java
 *
 * <p>此实现遵循以下逻辑：
 * <ul>
 * <li>从StateService导出状态</li>
 * <li>通过 MemoryAdapter 和 LongTermMemoryAdapter 创建 ReActAgent</li>
 * <li>加载状态（如有）</li>
 * <li>流式代理响应</li>
 * <li>完成后保存状态</li>
 * </ul>
    ...
    public Flux<Event> streamQuery(AgentRequest request, Object messages) {
        ...
        try {
            ...
            ReActAgent.Builder agentBuilder = ReActAgent.builder()
                    .name("Assistant")
                    .sysPrompt(BROWSER_SYSTEM_PROMPT)
                    .toolkit(toolkit)
                    .model(
