  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <Title level={4}>管理 - Agent管理</Title>
        <Text type="secondary">配置各个Agent角色的权限、模型、功绩统计等。</Text>
      </div>
      ...
      {alive.length > 0 && (
        <Card size="small" style={{ marginBottom: 16, background: '#f6ffed', borderColor: '#b7eb8f' }}>
          <Space wrap>
            ...
            <Text type="secondary" style={{ fontSize: 12, marginLeft: 16 }}>其余Agent待命</Text>
          </Space>
        </Card>
      )}
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        <Col xs={12} sm={12} md={6}>
          <Card>
            <Statistic title="在职Agent" value={offs.length} valueStyle={{ color: '#1677ff' }} />
          </Card>
        </Col>
        <Col xs={12} sm={12} md={6}>
          <Card>
            <Statistic title="累计完成任务" value={totals.tasks_done || 0} valueStyle={{ color: '#faad14' }} />
          </Card>
        </Col>
        <Col xs={12} sm={12} md={6}>
          <Card>
            ...
            {sel ? (
              <div>
                ...
                <Row gutter={16} style={{ marginBottom: 24, textAlign: 'center' }}>
                  <Col span={8}>
                    <Statistic title="完成任务" value={sel.tasks_done} valueStyle={{ color: '#52c41a' }} />
                  </Col>
                  <Col span={8}>
                ...
                <Divider plain>参与任务 ({sel.participated_edicts?.length || 0} 道)</Divider>
                <List
                  size="small"
              ...
              <Empty description="选择左侧Agent查看详情" style={{ marginTop: 100 }} />
            )}
          </Card>
        </Col>
      </Row>
