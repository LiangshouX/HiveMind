...
@WebMvcTest(controllers = EdictTaskFlowLogController.class)
class EdictTaskFlowLogControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private IEdictTaskFlowLogService service;
    ...
    void testGetById() throws Exception {
        ...
        mockMvc.perform(get("/api/edict-task-flow-logs/{id}", 1L))
