...
@WebMvcTest(controllers = EdictMemorialController.class)
class EdictMemorialControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private IEdictMemorialService service;
    ...
    void testGetById() throws Exception {
        ...
        mockMvc.perform(get("/api/edict-memorials/{id}", 1L))
