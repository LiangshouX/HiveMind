 ...
 * </ol>
 *
 * <p><strong>设计模式：</strong>使用 Mockito 框架模拟依赖服务（{@link com.liangshou.agentic.application.IConversationPersistenceService}
 * 和 {@link com.liangshou.agentic.agents.session.AgentSessionStateService}），
 ...
 * @see com.liangshou.agentic.application.IChatCommandService
 * @see com.liangshou.agentic.agents.ConversationSessionContext
 * @see com.liangshou.agentic.application.dto.ChatResponse
 */
@ExtendWith(MockitoExtension.class)
class ChatCommandServiceImplTest {

    @Mock
    private IConversationPersistenceService persistenceService;
