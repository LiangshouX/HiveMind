...
@WebMvcTest(controllers = SysModelsController.class)
class SysModelsControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockBean
    private ISysModelsService service;
    ...
    void testGetById() throws Exception {
        ...
        mockMvc.perform(get("/api/sys-modelss/{id}", 1L))
