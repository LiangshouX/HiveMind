...
public class SystemTaskTemplateInitializer implements CommandLineRunner {
    ...
    private static final SystemTemplate[] BUILTIN_TEMPLATES = {
        new SystemTemplate(
            ...
            "基于本周看板数据和各组产出，自动生成结构化周报",
            "📝", List.of("数据组", "文档组"), "~10分钟", "¥0.5",
            List.of(
