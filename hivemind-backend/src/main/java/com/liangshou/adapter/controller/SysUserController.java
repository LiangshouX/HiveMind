...
public class SysUserController {
     ...
     *
     * @param id 主键ID
     * @return 包含 SysUserVO 详情的 Result 对象
     */
     ...
     * 新增 SysUser 记录
     *
     * @param dto 包含新增数据的 SysUserDTO 对象
     ...
     *
     * @param id  主键ID
     * @param dto 包含更新数据的 SysUserDTO 对象
     * @return 包含更新结果(true/false)的 Result 对象
     */
    @Operation(summary = "更新记录", description = "根据主键更新已有记录")
    @PutMapping("/{id}")
    public Result<Boolean> update(@PathVariable Long id, @RequestBody SysUserDTO dto) {
        dto.setId(id);
