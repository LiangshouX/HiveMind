...
[![AgentScope](https://img.shields.io/badge/AgentScope-1.0.11-blue.svg)](https://agentscope.io/)

**TangDynasty（唐王朝）** 是一个基于多 Agent 协作架构的个人 AI 助理平台，以中国古代"三省六部"制度为蓝本，对各类 AI Agent 进行组织与工作分配，实现一套制度化、流程化、职责分明的 AI 多 Agent 协作框架。

---

## 📖 简介

TangDynasty 将 AI Agent 的能力与古代官僚制度的智慧相结合，通过模拟唐朝的三省六部制，构建了一个层次分明、职责清晰的多 Agent 协作系统。系统能够自动将复杂任务拆解为子任务，分配给不同的 Agent 执行，并通过审议机制确保执行质量。

### 核心理念

- **制度化协作**：借鉴三省六部制，建立规范的任务流转机制
...
访问 `http://localhost:5173` 即可使用 TangDynasty 控制台。
...
| **console** | Web 用户界面，提供与 AI 助理交互的所有功能 | React + TypeScript + Ant Design |
...
- **项目主页**: [GitHub](https://github.com/your-org/tang-dynasty)
- **问题反馈**: [Issues](https://github.com/your-org/tang-dynasty/issues)
